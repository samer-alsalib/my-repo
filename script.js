window.onload = function () {
  ...
  itemAdds.forEach((itemAdd) => {
    itemAdd.onclick = () => {
      ...
      newSpan1.innerText = itemAdd.parentElement.parentElement
        .querySelector(".item-name-c")
        .querySelector(".item-name").innerText;
      newSpan2.innerText = itemAdd.parentElement.parentElement
        .querySelector(".item-price-c")
      ...
      totalPrice += +itemAdd.parentElement.parentElement
        .querySelector(".item-price-c")
        .querySelector(".item-price").innerText;
